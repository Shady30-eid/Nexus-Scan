...
var KnownMalwarePackages = []struct {
        ...
        // ── MIUI / Xiaomi Pre-installed Telemetry & PUPs ─────────────────────────
        {"com.miui.analytics", "MIUI.Analytics", "Spyware", "HIGH", "MIUI built-in analytics SDK—sends device usage, app behavior, and content data to Xiaomi servers."},
        {"com.xiaomi.finddevice", "Mi.FindDevice", "Spyware", "MEDIUM", "Xiaomi Find My Device: can track location silently if activated remotely."},
        {"com.xiaomi.xmsf", "MIUI.PushService", "Spyware", "MEDIUM", "Xiaomi Push Service: persistent background process receiving remote commands."},
        {"com.miui.daemon", "MIUI.Daemon", "Spyware", "HIGH", "MIUI background daemon with undocumented system-level access."},
        {"com.xiaomi.mipicks", "Mi.GetApps", "PUP", "MEDIUM", "Xiaomi GetApps store: installs apps silently, bypasses Google Play verification."},
        {"com.miui.cloudservice", "MIUI.CloudSync", "Spyware", "MEDIUM", "MIUI Cloud Service: syncs contacts, SMS, photos, and call logs to Xiaomi servers."},
        {"com.miui.cloudbackup", "MIUI.CloudBackup", "Spyware", "MEDIUM", "MIUI Cloud Backup: uploads full device backup to Xiaomi cloud without explicit consent."},
        {"com.xiaomi.payment", "Mi.Payment", "PUP", "MEDIUM", "Xiaomi payment service with broad financial permissions."},
        {"com.miui.securitycenter", "MIUI.SecurityCenter", "PUP", "LOW", "MIUI Security Center: can uninstall apps and modify system settings remotely."},
        {"com.xiaomi.gamecenter.sdk.service", "Mi.GameCenter", "PUP", "LOW", "Xiaomi Game Center with persistent background process and ad delivery."},
        {"com.miui.contentextension", "MIUI.ContentExt", "Spyware", "MEDIUM", "MIUI content scanning extension reads notification content from other apps."},
        {"com.miui.systemads", "MIUI.SystemAds", "Adware", "MEDIUM", "MIUI system-level adware injecting ads into stock apps and lock screen."},
        {"com.xiaomi.market", "Mi.Market", "PUP", "MEDIUM", "Xiaomi app market with silent install capabilities."},
        {"com.qualcomm.qti.qms.service.telemetry", "Qualcomm.Telemetry", "Spyware", "HIGH", "Qualcomm telemetry service: collects device diagnostics and transmits to Qualcomm/OEM."},
        {"com.qualcomm.atfwd", "Qualcomm.ATFWD", "Spyware", "HIGH", "Qualcomm AT-command forwarding daemon: allows remote AT command execution on modem."},
        {"com.qti.dpmserviceapp", "Qualcomm.DPM", "Spyware", "MEDIUM", "Qualcomm Data Protection Manager: monitors network traffic and data usage."},

        // ── Samsung / Other OEM Pre-installed PUPs ────────────────────────────────
        {"com.samsung.android.spay", "Samsung.Pay.Spy", "Spyware", "MEDIUM", "Samsung Pay with background payment card data access."},
        {"com.samsung.clipboardsaveservice", "Samsung.ClipSpy", "Spyware", "MEDIUM", "Samsung clipboard service that logs clipboard content."},
        {"com.samsung.android.bixby.agent", "Bixby.DataCollect", "Spyware", "MEDIUM", "Bixby assistant collects voice data and usage patterns sent to Samsung."},
        {"com.coloros.push", "ColorOS.PushSpy", "Spyware", "MEDIUM", "OPPO/ColorOS push service with persistent C2-like remote command channel."},
        {"com.heytap.market", "HeyTap.Market", "PUP", "MEDIUM", "OPPO HeyTap Market with silent install capabilities."},
        {"com.vivo.pushclient", "Vivo.PushClient", "Spyware", "MEDIUM", "Vivo push client exfiltrating device telemetry to Vivo servers."},
